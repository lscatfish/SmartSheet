...
extern "C" __declspec(dllexport) void SetModelDir(const char *det_dir, const char *rec_dir, const char *cls_dir, bool use_cls) {
...
extern "C" __declspec(dllexport) void SetRecDictPath(const char *dictPath) {
